      ...
      <Animated.View style={[styles.ContainerMainContent, { bottom: HeightAnimationInterpolate }]}>
        ...
        <View style={styles.BlockingPointsMainView}>
          <View style={styles.BlockingPointView}>
            ...
            {unBlockUser ?
              <Text style={styles.BlockingPointText}>They will be able to message you or find your profile or content on instagram.</Text>
              : <Text style={styles.BlockingPointText}>They won't be able to message you or find your profile or content on instagram.</Text>}
          </View>
          <View style={styles.BlockingPointView}>
            <View style={styles.BlockingPointIconView}>
