...
const SelectInterests = ({ Interests, setInterests }) => {
  ...
  const interests = [
    ...
    "Spirituality", "Crafts", "Languages", "Cars", "Outdoor Activities", "Social Media", "Entertainment", "Fashion", "Technology",
    "Music", "Books", "Travel", "Food", "Fitness", "Movies", "Photography", "Fashion", "Sports", "Gaming", "Cooking", "Nature",
    "Science", "History", "Writing", "DIY", "Pets", "Health", "Finance", "Education", "Politics", "Astrology", "Spirituality",
    "Crafts", "Languages", "Cars", "Outdoor Activities", "Social Media", "Entertainment"
  ];
