          ...
          <ScrollView style={styles.MainContent}>
            ...
            <View style={styles.ChatOptions}>
              ...
              <View style={styles.ChatOptionsContainer}>
                ...
                {/* <Pressable style={styles.ChatOptionsButton}>
                  <Image source={require('../assets/Icons/ChatInfoOptionsIcon.png')} style={styles.ChatOptionsButtonImage} />
                  <Text style={styles.ChatOptionsButtonText}>Options</Text>
                </Pressable> */}
              </View>
            </View>
