...
const Account = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.Container}>
            ...
            <View style={styles.ProfileDetails}>
              ...
              {!userBlocked &&
                <View style={styles.ProfileFollowingInfo}>
                  ...
                  {/* <Pressable style={styles.FollowingBestfriendButton}>
                    <Image source={require('../assets/Icons/BestFriend.png')} style={styles.FollowingBestfriendButtonImage} />
                    <Text style={styles.FollowingButtonsText}>Henry Cavil</Text>
                  </Pressable> */}
                </View>}
                    ...
                    {chatmate &&
                      <>
                        ...
                        {/* <Pressable style={styles.CallButton}>
                          <Image source={require('../assets/Icons/CallWhiteFilled.png')} style={styles.CallButtonImage} />
                        </Pressable>
                        <Pressable style={styles.VideoCallButton}>
                          <Image source={require('../assets/Icons/VideoCallWhiteFilled.png')} style={styles.VideoCallButtonImage} />
                        </Pressable> */}
                      </>}
                  </View>))
              }
      ...
      {/* <Modal visible={showMessageModal} presentationStyle='overFullScreen' transparent={true} animationType='slide' statusBarTranslucent={true}>
        <View style={{ alignItems: 'center', justifyContent: 'center', height: '100%', width: '100%', backgroundColor: '#000000b3' }}>
          <View style={{ backgroundColor: '#fff', height: moderateScale(100), width: moderateScale(240), padding: moderateScale(12), }}>
            <Text style={{ color: '#333', fontSize: Height * 0.018, fontWeight: '500', lineHeight: Height * 0.022, }}>
              Please Restart the App To start Talking with {CurrentUserData.username}.
            </Text>
            <Pressable style={{ height: '100%', alignItems: 'flex-end', justifyContent: 'center', paddingBottom: moderateScale(1), paddingRight: moderateScale(10) }}>
              <Text style={{ color: '#F7706E', fontSize: Height * 0.02, fontWeight: '600', }}>OK</Text>
            </Pressable>
          </View>
        </View>
      </Modal> */}
