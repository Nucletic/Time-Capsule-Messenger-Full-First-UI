          ...
          {(!blockedFromOtherSide && !blockedFromOurSide) &&
            <>
              <Pressable style={styles.CallButton}>
                <Image source={require('../assets/Icons/Call.png')} style={styles.CallButtonImage} />
              </Pressable>
              <Pressable onPress={() => { navigation.navigate('OutCallScreen', { chatId: chatId }) }} style={styles.CallButton}>
                <Image source={require('../assets/Icons/VideoCall.png')} style={styles.CallButtonImage} />
              </Pressable>
            </>
          }
      ...
      {(loading && !messages) ? (
        ...
        <>
          ...
          <View style={styles.ChatBoxBottomContent}>
                ...
                <>
                  {(!attachedImages.length > 0) &&
                    <>
                      ...
                      {/* <Pressable onPress={() => setShowEmojiBoard(!showEmojiBoard)} style={styles.MessageBoxButton}>
                        <Image source={require('../assets/Icons/Emojis.png')} style={styles.MessageBoxButtonImage} />
                      </Pressable> */}
                    </>
                  }
                  <View style={[styles.MessageInputView, attachedImages.length > 0 && { width: '90%' }]}>
                    ...
                    {/* {!attachedImages.length > 0 &&
                      <Pressable onPressIn={() => { startRecording() }} onPressOut={() => { stopRecording() }} style={styles.MessageBoxButton}>
                        <Image source={require('../assets/Icons/RecordAudio.png')} style={styles.MessageBoxButtonImage} />
                      </Pressable>} */}
                  </View>
            ...
            {/* {isRecording &&
              <View style={styles.ChatBoxRecordingOptions}>
                <Pressable style={styles.RecordingDeleteButton}>
                  <Image source={require('../assets/Icons/DeleteAudio.png')} style={styles.RecordingDeleteButtonImage} />
                </Pressable>
                {TimeTextAnimationCompleted &&
                  <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.SoundBarsView} >
                    {soundLevels.map((level, index) => (
                      <View key={index} style={[styles.bar, { height: `${level * 0.1}%` }]} />
                    ))}
                  </ScrollView>}
                <Text style={styles.RecordingDurationText}>
                  {recordingDuration === '00:00' ? '00:00' : getDurationFormatted(recordingDuration)}</Text>
              </View>} */}
          </View>
